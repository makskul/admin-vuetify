...
export const createLayouts = (userConfig: UserConfig): Plugin => {
  ...
  const localStorageVertical = localStorage.getItem(`${userConfig.app.title}-Vertical`)
  ...
  config.app.contentLayoutNav.value = localStorageVertical || userConfig.app.contentLayoutNav
